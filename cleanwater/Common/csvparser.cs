...
namespace cleanwater.Common
{
    public sealed class CsvParser
    {
        ...
        /// </summary> 
        public CSVParserWinRT.IParserEngine ParserEngine { get; private set; }
        ...
        {
            InitializeFields();
            this.ParserEngine = new CSVParserWinRT.ParserEngines.BetterParserEngine();
        }
